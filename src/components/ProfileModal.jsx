  ...
  return (
    ...
    onClick={() => showProfileModal(prev => !prev)}>
        <div className='bg-[#131949] p-6 space-y-4 text-2xl rounded w-full max-w-sm max-h-sm border-l-8 border-l-[#00072D]'>
            ...
            <li className='flex items-center gap-3 font-semibold'><Coins className='font-bold text-amber-700' />Available Coin: <span className='text-amber-400'>{count} EIA</span></li>
            <li className='flex items-center gap-3 font-semibold'><DollarSign className='text-amber-300' />Total Earned : <span className='text-amber-400'>${dollarCount}</span></li>
